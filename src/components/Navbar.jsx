          ...
          {user && (
           ...
           {user && (
             <div className="dropdown dropdown-end">
              ...
              >
                                 {/* Theme toggle - visible on smaller screens where navbar theme toggle is hidden */}
                 <li className="md:hidden">
                   <a 
                     ...
                     onClick={(e) => {
                       ...
                       setTheme(newTheme);
                       // Force close by removing focus from the dropdown trigger
                       const dropdownTrigger = document.querySelector('[data-theme]');
                       if (dropdownTrigger) {
                ...
                <li>
                  <Link to={"/savedLikedProfiles"} className="justify-between" onClick={() => document.activeElement && document.activeElement.blur()}>
                    <div className="flex items-center gap-2">
                      ...
                      <div className="badge badge-primary badge-xs ml-auto">5</div>
                    </div>
                  </Link>
                </li>
