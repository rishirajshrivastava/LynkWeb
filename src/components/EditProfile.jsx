...
const EditProfile = ({ setMode, setIsPreview, defaultPreview = false }) => {
  ...
  return (
    <div className="bg-base-100 rounded-3xl shadow-xl overflow-hidden border border-base-300/50 flex flex-col">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 p-6 flex-1">
        {/* Live Preview Panel (Left) */}
        <div className="bg-base-200/50 rounded-2xl border border-base-300/30">
          <div className="p-4">
            <h3 className="text-base font-semibold text-base-content mb-3 flex items-center">
        ...
        <div className="bg-base-200/50 rounded-2xl border border-base-300/30">
          <div className="p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="form-control">
                  <label className="label">
                    <span className="label-text font-medium text-base-content/80 text-sm">First Name</span>
                  </label>
                  <input 
                    type="text" 
                    className="input input-bordered w-full h-10 text-sm bg-base-100 focus:border-primary focus:ring-1 focus:ring-primary/20" 
                    value={firstName} 
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text font-medium text-base-content/80 text-sm">Last Name</span>
                  </label>
                  <input 
                    type="text" 
                    className="input input-bordered w-full h-10 text-sm bg-base-100 focus:border-primary focus:ring-1 focus:ring-primary/20" 
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium text-base-content/80 text-sm">About You</span>
                </label>
                <textarea 
                  className="textarea textarea-bordered w-full h-32 text-sm resize-none bg-base-100 focus:border-primary focus:ring-1 focus:ring-primary/20" 
                  value={about} 
                  onChange={(e) => setAbout(e.target.value)}
                  placeholder="Tell others about yourself, your interests, or what you're looking for..."
                />
                <div className="mt-1">
                  <span className="text-xs text-base-content/60">Share your story, interests, or what you're looking for</span>
                </div>
              </div>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium text-base-content/80 text-sm">Profile Photo URL</span>
                </label>
                <input 
                  type="url" 
                  className="input input-bordered w-full h-10 text-sm bg-base-100 focus:border-primary focus:ring-1 focus:ring-primary/20" 
                ...
                />
                <div className="mt-1">
                  <span className="text-xs text-base-content/60">Paste a direct link to your profile image</span>
                </div>
              </div>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium text-base-content/80 text-sm">Skills & Interests</span>
                </label>
                <input 
                  type="text" 
                  className="input input-bordered w-full h-10 text-sm bg-base-100 focus:border-primary focus:ring-1 focus:ring-primary/20" 
                ...
                />
                <div className="mt-1">
                  <span className="text-xs text-base-content/60">Separate multiple skills with commas</span>
                </div>
              </div>
              ...
              <div className="pt-3">
                <div className="flex flex-col sm:flex-row justify-center gap-2">
                  <button 
                    ...
                    className={`btn btn-primary btn-sm w-full sm:w-auto ${submitting ? 'btn-disabled' : ''}`} 
                    disabled={submitting}
                  >
                    {submitting ? (
                      <>
